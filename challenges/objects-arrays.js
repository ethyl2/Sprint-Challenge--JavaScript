console.log('In Objects Section:');
// ==== Objects ====
...
/* Request 2: Create a new array called contactInfo that contains both first name and
 email of each student. This will be an array of strings.
...
console.log("Contact Info (first_name email): ");
...
console.log("universities with 'Uni'");
...
console.log("Animal displayNames:");
...
this pattern: "jackal, asiatic". Log the result.
...
*/
console.log('Stretch: Done. Array method callbacks are arrow functions.');
